...
#define MAX_DELTA_DELTA_R (MAX_ACCELERATION)/(SPEED_ADJUSTMENT_FREQUENCY*SPEED_ADJUSTMENT_FREQUENCY)
#define MAX_DELTA_DELTA_D (MAX_ROTATE_ACCELERATION)/(SPEED_ADJUSTMENT_FREQUENCY*SPEED_ADJUSTMENT_FREQUENCY)
